...
enum xmrstak_algo_id
{
	...
	cryptonight_upx2 = (start_derived_algo_id + 4),
...
constexpr uint32_t CN_UPX2_ITER = 0x4000;
...
inline xmrstak_algo POW(xmrstak_algo_id algo_id)
{
	...
	static std::array<xmrstak_algo, 5> derived_pow =
		{{
			...
			{cryptonight_upx2, cryptonight_monero_v8, CN_UPX2_ITER, CN_MEMORY / 16, CN_TURTLE_MASK},
			// {cryptonight_derived}
		}};
